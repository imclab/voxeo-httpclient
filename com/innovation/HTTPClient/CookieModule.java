...
public class CookieModule implements HTTPClientModule
{
	...
	boolean persist;
	try
	    { persist = Boolean.getBoolean("com.innovation.HTTPClient.cookies.save"); }
	catch (Exception e)
	    { persist = false; }
	...
	try
	    { file = System.getProperty("com.innovation.HTTPClient.cookies.jar"); }
	catch (Exception e)
	    { }
...
class DefaultCookiePolicyHandler implements CookiePolicyHandler
{
	...
	try
	    { list = System.getProperty("com.innovation.HTTPClient.cookies.hosts.accept"); }
	catch (Exception e)
	    { list = null; }
	...
	try
	    { list = System.getProperty("com.innovation.HTTPClient.cookies.hosts.reject"); }
	catch (Exception e)
	    { list = null; }
